...
CREATE TABLE OPTIMIZATION(
        OPTI_NUM INT PRIMARY KEY AUTO_INCREMENT,
        ...
        SOIL_MIN FLOAT NOT NULL,
        SOIL_MAX FLOAT NOT NULL,
        LUX_MIN INT NOT NULL,
        LUX_MAX INT NOT NULL,
        CREATE_DATE DATETIME DEFAULT SYSDATE()
);

SELECT * FROM temper_humidity;