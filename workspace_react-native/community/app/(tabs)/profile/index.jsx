...
const ProfileHomeScreen = () => {
  ...
  // 버튼1 클릭 시 실행 함수
  const test1 = () => {
    axios.get('http://192.168.30.79:5000/t1')
  ...
  const test2 = () => {
    axios.get('http://192.168.30.79:5000/t2/5')
  ...
  // post 방식으로 데이터 가져가기
  const test3 = () => {
    axios.post('http://192.168.30.79:5000/t3', {
      stuName: 'kim',
      stuAge: 20
    })
    .then(res => console.log('통신 성공'))
  ...
  const test4 = () => {
    axios.get('http://192.168.30.79:5000/t4', {params: {
      stuName: 'kim',
      stuAge: 20
    }})
    .then(res => console.log('통신 성공'))
