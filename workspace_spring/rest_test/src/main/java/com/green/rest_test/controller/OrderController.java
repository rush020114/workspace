...
public class OrderController {
  ...
  public List<OrderDTO> getOrderList(){
    ...
    orderDTOList.add(new OrderDTO(101, "데님 청바지", 15000, 2, "abc", 30000));
    orderDTOList.add(new OrderDTO(102, "맨투맨 반팔 티셔츠", 10000, 3, "def",30000));
    orderDTOList.add(new OrderDTO(103, "오버핏 니트", 25000, 2, "ghi", 50000));
    orderDTOList.add(new OrderDTO(104, "롱 패딩", 55000, 1, "jkl", 55000));
    orderDTOList.add(new OrderDTO(105, "맨투맨 긴팔 티셔츠", 12000, 3, "mno", 36000));
    return orderDTOList;
  }
