...
#2. 결제방법이 계좌이체이며, 결제금액이 만원을 초과한 주문에 대한 
#   주문상품명, 주문수량, 결제금액, 결제방법을 조회하되, 결제일이 최신인 데이터부터 조회하시오.
...
#3. 결제일이 2025-01-20일 이전인 주문 중, 
#   주문수량이 주문 수량이 홀수인 주문들의 주문번호, 주문수량, 주문자ID, 결제일을 조회하시오.
...
FROM order_info O INNER JOIN pay_info P
ON O.PAY_NUM = P.PAY_NUM
WHERE PAY_DATE <= '2025-01-20'
AND MOD(ORDER_CNT, 2) = 1;